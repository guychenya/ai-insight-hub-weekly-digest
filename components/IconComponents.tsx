...
export const IconNewspaper: React.FC<IconProps> = ({ className }) => (
...
export const IconStar: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.384l-4.12 3.535 1.217 5.273c.279 1.202-.936 2.148-2.002 1.587L12 18.283l-4.502 2.926c-1.065.562-2.28-.385-2.002-1.587l1.217-5.273-4.12-3.535c-.887-.84-.415-2.291.749-2.384l5.404-.434L10.788 3.21Z" clipRule="evenodd" />
  </svg>
);
